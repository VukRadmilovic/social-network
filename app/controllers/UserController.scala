...
class UserController @Inject() (
  ...
  /**
   * Search for users whose usernames or display names match a specified string
   *
   * Pagination parameters (limit and page) can be optionally provided to control the number of results per page
   * and the page number.
   *
